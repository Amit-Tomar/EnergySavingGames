...
Image
{
    ...
    {
        id: about2
        text: "2. All Images(other than bulbs) used in this game have been drawn using\n GIMP, the opensource image editor."
        font.pixelSize: 20
        font.family: "purisa"
        color: "white"
        anchors.left: infoRect.left
